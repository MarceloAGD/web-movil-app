  ...
  return (
    <ThemeProvider value={colorScheme === 'light' ? DarkTheme : DefaultTheme}>
      <Stack initialRouteName='index'>
        ...
        <Stack.Screen name="project" options={{presentation: 'fullScreenModal',headerShown: true , headerTitle: '', headerTransparent: true}} />
        ...
        <Stack.Screen name="task/addTask" options={{presentation: 'fullScreenModal',headerShown: true , headerTitle: '', headerTransparent: true, headerTintColor: 'black'}}/>
